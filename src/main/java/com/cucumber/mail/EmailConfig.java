...
public class EmailConfig {
    ...
    public static final String FROM = "danghoanghuy.0910@gmail.com";
    public static final String PASSWORD = "urhr vhun udry zblc";

    public static final String[] TO = {"danghoanghuy.0910.2@gmail.com"};
